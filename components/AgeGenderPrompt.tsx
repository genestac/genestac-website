      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-5">
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500">We need your age & gender for recommendations</p>
          </div>
        </div>

        <div className="space-y-4">
          <div>
            <label className="text-xs font-semibold text-slate-700 mb-1.5 block">Age *</label>
            <input
              ref={ageRef}
              type="number"
              value={age}
        ...
        <div className="flex gap-2.5 mt-6">
          <button
            onClick={onClose}
            disabled={saving}
            className="flex-1 py-2.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-semibold rounded-xl transition disabled:opacity-50"
          >
            Skip
          </button>
          <button
