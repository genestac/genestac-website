        ...
        <div className="w-full max-w-[480px] bg-white rounded-[24px] shadow-xl p-8 md:p-12 relative z-10">
          ...
          {/* <div className="mt-10">
            <div className="relative flex items-center mb-8">
              ...
              <span className="flex-shrink mx-4 text-sm font-semibold text-slate-500 px-2">Or sign in with</span>
              <div className="flex-grow border-t border-slate-200"></div>
            </div>
            <div className="flex gap-4">
              <button
                  ...
                  className="flex-1 flex items-center justify-center gap-3 py-3 border border-slate-200 rounded-2xl hover:bg-slate-50 transition-colors cursor-pointer"
                >
